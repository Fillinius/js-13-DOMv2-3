...
mainNew.insertAdjacentElement("afterend", newDiv)
   ...
   // Функция изменеия класса модально окна  
//  function change (){
...
button.addEventListener('click', (event)=>{
  ...
  // const taskExist1 = arrChange.findIndex((name, index) => index
  // )
  // console.log('taskExist1', taskExist1);
  // console.log('taskId', taskId );
  //   if(taskExist1){
  //   const element = document.querySelector('#taskId')
  //   console.log(element);
  //   element.remove()
  //     const taskExist2 = tasks.find(index=> index===taskId)
  //     if(taskExist2){
  ...
  //   hidden.className = "modal-overlay modal-overlay_hidden"
  //   console.log(tasks);
  //   const taskExist1 = tasks.findIndex(index=> index===taskId)
  //     if(taskExist1){
  //     tasks.splice(taskId, 1)
  //     console.log('массив после удаления', tasks);
  //       }
